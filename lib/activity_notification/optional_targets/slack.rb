  ...
  module OptionalTarget
    ...
    class Slack < ActivityNotification::OptionalTarget::Base
      ...
      def notify(notification, options = {})
        ...
        channel = notification.target.resolve_value(@channel)
        
        @notifier.ping(render_notification_message(notification, options.merge(assignment: { target_username: target_username, channel: channel })))
      end
    end
  end
end
